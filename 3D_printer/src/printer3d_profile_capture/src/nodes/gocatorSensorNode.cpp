...
class GocatorSensorNode : public rclcpp::Node
{
  public:
    ...
    : Node("gocatorSensorNode")
    {
        ...
        service_ = this->create_service<printer3d_gocator_msgs::srv::GocatorPTCloud>("gocator_get_profile", std::bind(&GocatorSensorNode::profile_snapshot, this, std::placeholders::_1, std::placeholders::_2));
        // publisher_ = this->create_publisher<sensor_msgs::msg::PointCloud2>("gocatorPTCloud_topic", 10);
    }

  private:
    void profile_snapshot(std::shared_ptr<printer3d_gocator_msgs::srv::GocatorPTCloud::Request> request,
